...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ipc = __webpack_require__(1);

	var _ipc2 = _interopRequireDefault(_ipc);

	var _remote = __webpack_require__(2);
	...
	var _recognition = __webpack_require__(160);

	var _recognition2 = _interopRequireDefault(_recognition);

	var _mmd = __webpack_require__(161);

	var _mmd2 = _interopRequireDefault(_mmd);
	...
	var Menu = _remote2.default.Menu;
	var MenuItem = _remote2.default.MenuItem;

	var recognitionStarted = false,
	    recognitionStopTimer = null;

	var sharedObject = _remote2.default.getGlobal('sharedObject');
	var robot = sharedObject.robot;
	var mascotConfig = sharedObject.mascotConfig;
	var mainWindow = sharedObject.mainWindow;

	var input = _reactDom2.default.render(_react2.default.createElement(_index.Input, {
	  placeholder: '',
	...
	var messages = _reactDom2.default.render(_react2.default.createElement(_index.Messages, { messages: [] }), document.getElementById('messages'));

	var mascot;
	console.log(mascot);
	if (mascotConfig.image) {
	  mascot = _reactDom2.default.render(_react2.default.createElement(_index.Mascot, {
	    src: mascotConfig.image,
	    style: { width: '100%' } }), document.getElementById('mascot'));
	} else if (mascotConfig.model) {
	  (0, _mmd2.default)(mascotConfig, document.getElementById('mascot'));
	}

	function addMessages(body, type) {
	...
	function notify(body) {
	  var title = arguments.length <= 1 || arguments[1] === undefined ? 'MascotOps' : arguments[1];
	  var icon = arguments.length <= 2 || arguments[2] === undefined ? null : arguments[2];
	...
	robot.on('send_inside', function (envelope, strings) {
	  addMessages(strings[0], 'chara');
	});

	robot.on('send_outside', function (envelope, strings) {
	  addMessages(strings, 'chara');
	});

	robot.on('receive_inside', function (message) {});

	robot.on('receive_outside', function (message, strings) {
	  if (strings) {
	...
	_recognition2.default.addEventListener('result', function (event) {
	...
	_recognition2.default.addEventListener('error', function (err) {
	  if (err.error != 'no-speech') {
	    console.error(err);
	  }
	});

	_ipc2.default.on('voice-input', function () {
	  if (recognitionStarted) {
	    clearTimeout(recognitionStopTimer);
	    _recognition2.default.stop();
	    recognitionStarted = false;
	    input.setState({ placeholder: '' });
	  } else {
	    _recognition2.default.start();
	...
	_ipc2.default.on('focus', function () {
	  document.body.classList.remove('blur');
	  document.querySelector('.input__text').focus();
	});

	_ipc2.default.on('blur', function () {
	...
	try {
	  var _loop = function _loop() {
	    ...
	    submenu.append(new MenuItem({ label: command.text, click: function click() {
	        robot.receiveInput(command.text);
	      }
	    }));
	  };

	  for (var _iterator = robot.userCommands[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	    _loop();
	  }
	} catch (err) {
	...
	window.addEventListener('contextmenu', function (e) {
	  e.preventDefault();
	  menu.popup(_remote2.default.getCurrentWindow());
	}, false);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Input = exports.Messages = exports.Mascot = undefined;
	...
	var Mascot = _react2.default.createClass({
	  displayName: 'Mascot',
	  render: function render() {
	    return _react2.default.createElement('div', { className: 'mascot', style: {
	    ...
	    var messages = this.state.messages.map(function (message) {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'pre',
	          { className: 'messages__item__body' },
